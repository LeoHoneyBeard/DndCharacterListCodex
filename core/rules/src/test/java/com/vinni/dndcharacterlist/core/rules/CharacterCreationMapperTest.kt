...
class CharacterCreationMapperTest {
    ...
    @Test
    fun mapsDraftAndDerivedStatsIntoCharacterRecord() {
        ...
        val entity = mapper.toCharacterRecord(
            draft = draft,
            derived = derived,
        ...
        assertTrue(entity.savingThrowProficiencies.contains("INTELLIGENCE"))
        assertTrue(entity.skillProficiencies.contains("arcana"))
    }
}
